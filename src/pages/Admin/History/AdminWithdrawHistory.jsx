        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            {pageData.length === 0 ? (
              ...
              pageData.map((w, i) => {
                const dateObj = new Date(w.created_at?.$date ?? null);
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 min-w-80">{w.tx_id}</td>

                    <td className="px-3 py-2 font-semibold text-red-400">
                      {w.amount}
                    </td>

                    <td className="px-3 py-2">{w.payment_method}</td>
                    ...
                    <td className="px-3 py-2 min-w-26">
                      {w.created_at ? dateObj.toLocaleDateString("en-IN") : "-"}
                    </td>

                    <td className="px-3 py-2 min-w-26">
                      {w.created_at ? dateObj.toLocaleTimeString("en-IN") : "-"}
                    </td>
                  </tr>
                );
              })
